...
describe 'nbs["||"](x, y)', ->
  ...
  it 'expect to return true; where x is true and y is false', ->
    (expect nbs['||'] true, false).to.equal true

  it 'expect to return true; where x is false and y is true', ->
    (expect nbs['||'] false, true).to.equal true
